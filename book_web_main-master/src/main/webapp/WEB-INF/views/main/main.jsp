...
<script>
	$(document).ready(function() {
		...
		var interval = 3000; // 각 슬라이드가 보여지는 시간 (3초)
			...
			<div class="container">
				<div class="row">
					<div class="col text-center mt-5">
						<p class="fs-3 fw-bold">문학 추천</p>
						<p class="fs-6">문학 베스트 상품</p>
					</div>
				</div>


                <div class="row mt-4 justify-content-center bg-light-gray">
                    <c:forEach var="item" items="${goodsMap.cate_mun}">
                        <c:if test="${item.goods_sort eq '문학'}"> <!-- '문학' 카테고리인지 확인 -->
                            <div class="col-6 col-md-4 col-lg-3 mb-4">
                                <div class="card">
                                    <a href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id}">
                                        <img class="card-img-top mx-auto" src="${contextPath}/download.do?goods_id=${item.goods_id}&fileName=${item.goods_fileName}" alt="${item.goods_title}">
                                    </a>
...
<%--			<div class="container">
				<div class="row">
					...
					<div class="mb-5">
						<a href="/goods/menuGoods.do?menuGoods=웹툰" class="btn btn-main rounded-0 w-100 d-block fw-bold p-2 lh-lg mb-3">바로가기</a>
					</div>
				...
				<div class="row mt-4 justify-content-center bg-light-gray">
					<c:forEach var="item" items="${goodsMap.cate_web}">
						<c:if test="${item.goods_sort eq '웹툰'}"> <!-- '문학' 카테고리인지 확인 -->
							<div class="col-6 col-md-4 col-lg-3 mb-4">
								<div class="card">
									<a href="${contextPath}/goods/goodsDetail.do?goods_id=${item.goods_id}">
										<img class="card-img-top mx-auto" src="${contextPath}/download.do?goods_id=${item.goods_id}&fileName=${item.goods_fileName}" alt="${item.goods_title}">
